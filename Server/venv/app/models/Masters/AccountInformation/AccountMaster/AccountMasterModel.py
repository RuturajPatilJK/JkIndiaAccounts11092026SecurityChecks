...
class AccountMaster(db.Model):
    ...
    Benificiary_Name = Column(String(255), nullable=True)
    Branch_Name = Column(String(255), nullable=True)
    Benificiary_Name1 = Column(String(255), nullable=True)
    Bank_Name1 = Column(String(255), nullable=True)
    Bank_Ac_No1 = Column(String(255), nullable=True)
    IFSC1 = Column(String(50), nullable=True)
    Branch_Name1 = Column(String(255), nullable=True)
