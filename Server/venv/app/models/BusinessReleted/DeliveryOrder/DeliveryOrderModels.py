...
class DeliveryOrderHead(db.Model):
    ...
    LockedRecord = db.Column(db.Boolean, nullable=True )
    ...
    UnitType=Column(String(3),nullable=True)
    PurchaseCSGTamt = db.Column(db.Numeric(18,2),nullable=True)
    PurchaseSGSTamt = db.Column(db.Numeric(18,2),nullable=True)
    PurchaseIGSTamt = db.Column(db.Numeric(18,2),nullable=True)
    PurchaseTCSamt = db.Column(db.Numeric(18,2),nullable=True)
    PurchaseTDSamt = db.Column(db.Numeric(18,2),nullable=True)
    PurchaseOtheramt = db.Column(db.Numeric(18,2),nullable=True)
    godownCode = db.Column(db.Integer,nullable=True)
    godownId = db.Column(db.Integer,nullable=True)
