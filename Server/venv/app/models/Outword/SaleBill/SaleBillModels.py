...
class SaleBillHead(db.Model):
    ...
    EwbDt=Column(Date,nullable=True)
    Actual_Distance=Column(Numeric(18,2),nullable=True)
    oldbno=Column(Numeric(18,0),nullable=True)
    godownCode=Column(Integer,nullable=True)
    godownId=Column(Integer,nullable=True)
