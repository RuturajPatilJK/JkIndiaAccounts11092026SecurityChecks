...
const EWayBillReport = ({ doc_no, ewayBillNo, Company_Code, Year_Code, disabledFeild }) => {
    ...
    return (
        <div >
            {/* <button  onClick={() => generatePdf(apiData)} disabled={disabledFeild} style={{height:"38px"}}>
                E-Way Bill Print
            </button> */}

            <PrintReport onClick={() => generatePdf(apiData)} disabled={disabledFeild}>
                E-way Bill
            </PrintReport>
