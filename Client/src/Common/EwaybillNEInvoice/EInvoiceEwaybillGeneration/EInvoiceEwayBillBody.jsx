...
export const invoiceDataEwayBills = (InvoiceData, tran_type) => {
  ...
  const invoiceData = {
    ...
    invoice_data: {
      ...
      ItemList: [
        {
          ...
          HsnCd: String(formData.HSN || "17011490"),
      ...
      EwbDtls: {
        ...
        Distance: 0,
        Vehno: formatVehicleNumber(formData.LORRYNO),
  ...
  if ((tran_type && tran_type.trim().toUpperCase() === "RB") || (tran_type && tran_type.trim().toUpperCase() === "LV")) {
