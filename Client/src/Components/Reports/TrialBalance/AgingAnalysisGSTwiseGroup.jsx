...
const AgingAnalysisReportCreditors_GST = () => {
  ...
  const API_URL = `${apikey}/AgingAnalysis-Report-Creditors_GST`;
  ...
  const handlePrint = () => {
    ...
    win.document.write(`
      <html>
        <head>
          <title>Aging Analysis Creditors PAN Wise</title>
          <style>
        ...
        <body>
          ...
          <div style="text-align:center;">Aging Analysis  PAN wise</div>
  ...
  const generatePdf = () => {
    ...
    doc.setFontSize(10);
    doc.text(`Aging Analysis - Creditors - GSTwise | As On: ${toDate}`, 14, 16);
...
export default AgingAnalysisReportCreditors_GST;
