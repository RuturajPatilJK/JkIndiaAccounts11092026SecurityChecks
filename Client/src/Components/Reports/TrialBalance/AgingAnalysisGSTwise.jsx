...
//     { label: 'Code', key: 'Ac_code', width: '10%' },
...
//     // { label: 'Net Diff',     key: 'NetDiff',   printWidth: '23mm', numeric: true },
// ];
...
//     const API_URL = `${apikey}/AgingAnalysis-Report-Debtorsgstwise`;
...
//     // ── Single declaration of all net diff variables ──────────
//     const netDiff = totals.debit - totals.credit;
//     const netDiffAbs = Math.abs(netDiff);
//     const netDiffSuffix = netDiff >= 0 ? " Dr" : " Cr";
//     const netDiffLabel = netDiff >= 0 ? "NET DIFFERENCE (Dr)" : "NET DIFFERENCE (Cr)";
...
//                 Trial Balance Report GST wise
//             </Typography>

//             <div className="my-3 d-flex justify-content-end no-print">
...
//             <TableContainer component={Paper} style={{ maxHeight: "800px", position: "relative" }}>
...
//                                 >
//                                     <TableCell>{item.Ac_code}</TableCell>
...
const SCREEN_COLUMNS = [
    { label: 'Gst No', key: 'Gst_No', width: '10%' },
    { label: 'Account Name', key: 'Ac_name', width: '40%' },
    { label: 'City', key: 'City_name', width: '20%' },
    { label: 'Credit (-)', key: 'Credit', width: '15%', numeric: true },
    { label: 'Debit (+)', key: 'Debit', width: '15%', numeric: true },
    ...
    return (
        <div style={{ marginTop: "-80px", padding: "20px" }}>
            ...
            <Typography variant="body2" align="center" sx={{ fontSize: '12px', color: '#444', mb: 0.5 }}>
                GST wise Trial Balance &nbsp;|&nbsp; <strong>{Groupname}</strong> &nbsp;|&nbsp; Period upto: <strong>{FormaDateBalanceSheet(toDate)}</strong>
            </Typography>
                    ...
                    <TableBody>
                        {sortedData.map((item, index) => {
                            ...
                            return (
                                <Tooltip
                                    key={index}
                                    title={`Click to view account-wise details for GST: ${item.Gst_No}`}
                                    placement="top"
                                    arrow
                                >
                                    <TableRow
