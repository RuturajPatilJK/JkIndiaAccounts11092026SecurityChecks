...
const PartyWiseMonthWiseSale = ({ fromDate, toDate }) => {
    ...
    const fetchPartyWiseSale = async () => {
        try {
            setLoading(true);
            setError('');
            const response = await axios.get(`${API_URL}/PartyWiseMonthWise-sale`, {
            ...
            if (response.data && response.data.length > 0) {
                ...
                Swal.fire({ icon: 'info', title: 'No Data Found', text: 'No sale records found.' });
            }
        } catch (err) {
    ...
    const openInNewWindow = (data) => {
        ...
        newWindow.document.write(`
            <html>
                <head>
                    ...
                    <style>
                        ...
                        .sticky-col1 { position: sticky; left: 0; background-color: #fff; z-index: 11; min-width: 250px; border-right: 1px solid #dee2e6; }
                ...
                <body>
                    <div class="header-container">
                        <h2>Party-wise Month-wise Sale With Taxable Amount</h2>
            ...
            // Map months into a string of TD elements
            ...
            return `
                    ...
                    <script>
                        ...
                        function exportToXlsx() {
                            ...
                            XLSX.writeFile(wb, "PartyWise_Monthly_Sale_Report_TaxableAmount.xlsx");
                        }
                    </script>
                </body>
            </html>
    ...
    return (
        <div className="d-flex flex-column align-items-center" style={{ marginTop: '5px', width: '100%' }}>
            ...
            >
                {loading ? <CircularProgress size={24} color="inherit" /> : 'Partywise Monthwise Sale with Taxable Amount'}
            </button> */}
...
export default PartyWiseMonthWiseSale;