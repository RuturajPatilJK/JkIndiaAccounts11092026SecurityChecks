  ...
  return (
    <>
      ...
      {/* <Box
        ...
        noValidate
        autoComplete="off"
        sx={{ maxWidth: 500, margin: '0 auto', padding: 4, backgroundColor: '#f4f6f8', borderRadius: 2, boxShadow: 2 }}
      >
        ...
        <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
          <form>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-6">
              <div>
                <label htmlFor="changeNo" className="block text-left text-sm font-bold text-gray-800 mb-1">
                  Change No
                </label>
                <input
                  id="changeNo"
              ...
              <div>
                <label htmlFor="State_Code" className="block text-left text-sm font-bold text-gray-800 mb-1 flex items-center">
                  State Code
              ...
              <div className="md:col-span-2">
                <label htmlFor="State_Name" className="block text-left text-sm font-bold text-gray-800 mb-1">
                  State Name
                </label>
                <input
                  id="State_Name"
