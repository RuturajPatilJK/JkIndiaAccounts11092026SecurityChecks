...
const DispatchDetailslRegister = () => {
    ...
    const handleExportToExcel = () => {
        ...
        const headers = ['Tran Type', 'Doc No', 'Date', 'Party Name', 'Debit', 'Credit'];
        wsData.push(headers);

        Object.entries(groupedReportData).forEach(([_, value]) => {
...
export default DispatchDetailslRegister;
