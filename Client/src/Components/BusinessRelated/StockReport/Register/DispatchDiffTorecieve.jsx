...
const DispatchDiffToRecieve = () => {
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, 'DispatchDiffRecieve');
        XLSX.writeFile(wb, 'DispatchDiffRecieve.xlsx');
    };
    ...
    return (
        <div style={{ marginTop: '-80px' }}>
            ...
            <Typography variant="h6" style={{ textAlign: 'center', fontSize: "20px", fontWeight: "bold" }}>Dispatch Difference Receive</Typography>
                            ...
                            {Object.entries(groupedReportData).map(([key, { items }]) => {
                                ...
                                return (
                                    <React.Fragment key={key}>
                                        <tr style={{ backgroundColor: '#f0f0f0', fontWeight: "500px" }}>
...
export default DispatchDiffToRecieve;
