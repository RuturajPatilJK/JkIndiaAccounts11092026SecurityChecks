  ...
  return (
    <div id="pdf-content">
      ...
      <div style={{ display: "flex", flexDirection: "row", gap: 8 }}>
        <PrintButton disabledFeild={disabledFeild} fetchData={fetchData} label={"Sale Bill"} />
        <PrintButton disabledFeild={disabledFeild} fetchData={() => fetchData(true)} label={"Sale Bill DSC"} />
      </div>
    </div>
  );
};
