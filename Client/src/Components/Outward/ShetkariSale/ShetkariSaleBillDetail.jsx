...
import BrandGrainBalanceHelp from "../../../Helper/BrandGrainBalanceHelp";
const ShetkariSaleBillDetail = ({
  show,
  onClose,
  selectedUser,
  formDataDetail,
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  <div className="SugarPurchaseBill-row">
                    ...
                    <div >
                      <div >
                        <BrandGrainBalanceHelp
                          onAcCodeClick={handleBrandCode}
                          name="Brand_Code"
                          BrandCode={brandCode || formDataDetail.Brand_Code }
                          ItemNo={ itemSelect }
...
export default ShetkariSaleBillDetail;